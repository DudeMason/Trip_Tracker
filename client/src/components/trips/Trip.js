...
export default class Trip extends Component {
	render() {
		...
		let start = (startDate.getUTCMonth() + 1) + "/" + startDate.getUTCDate() + "/" + startDate.getUTCFullYear();
		let end = (endDate.getUTCMonth() + 1) + "/" + endDate.getUTCDate() + "/" + endDate.getUTCFullYear();
				...
				<div>
					<>
						{edit
						 ?
						 <div align='left'>
							 <TripForm {...this.props} toggleIt={toggleIt} start={start} end={end}/>
						 </div>
						 :
						 <>
							 <Link to={{
